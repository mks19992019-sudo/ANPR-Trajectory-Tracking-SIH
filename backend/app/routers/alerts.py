...
from backend.app.models.entities import Alert, Camera
...
def list_alerts(
    ...
    """
    Lists active and historical alerts filterable by severity and status.
    """
...
def update_alert_status(
    ...
    """
    Updates status of an alert (OPEN -> INVESTIGATING -> RESOLVED).
    """
